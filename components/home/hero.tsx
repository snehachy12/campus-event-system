        ...
        <div className="container mx-auto px-4 py-24 sm:py-32 relative z-10 flex-1 flex flex-col">
          <div className="mx-auto max-w-4xl text-center flex-1 flex flex-col justify-center">
            ...
            <motion.div
              ...
              className="mb-8"
            >
              <Badge variant="secondary" className="inline-flex items-center gap-2 px-4 py-2 text-sm bg-gradient-to-b from-primary to-primary/80 text-primary-foreground border-primary/30">
            ...
            >
              <h1 id="main-title" className="text-4xl font-bold tracking-tight text-foreground sm:text-6xl lg:text-7xl">
                All your daily <strong>campus needs</strong> in one place
              </h1>
            </motion.div>
            ...
            >
              Timetables, events, resources, navigation, attendance and internships 
              — unified with role-based access for Students, Teachers, Event Coordinators and Admin.
            </motion.p>
            ...
            >
              ...
              {/* Role-based CTAs - Updated with larger button classes */}
              <div className="flex flex-col sm:flex-row justify-center gap-6 w-full max-w-2xl">
                <a href="/signup/student" className="rounded-md font-bold relative cursor-pointer hover:-translate-y-0.5 transition duration-200 inline-block text-center bg-gradient-to-b from-primary to-primary/80 text-primary-foreground shadow-[0px_2px_0px_0px_rgba(255,255,255,0.3)_inset] px-10 py-4 text-lg min-w-[200px]">
                  I'm a Student
                </a>
                <a href="/signup/teacher" className="rounded-md font-bold relative cursor-pointer hover:-translate-y-0.5 transition duration-200 inline-block text-center bg-gradient-to-b from-primary to-primary/80 text-primary-foreground shadow-[0px_2px_0px_0px_rgba(255,255,255,0.3)_inset] px-10 py-4 text-lg min-w-[200px]">
                  I'm a Teacher
                </a>
              </div>
            </motion.div>
