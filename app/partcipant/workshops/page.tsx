  ...
  return (
    <div className="min-h-screen bg-black flex">
      ...
      <main className="flex-1 p-8 overflow-auto">
        <h1 className="text-3xl font-bold text-white mb-2">Workshops & Bootcamps</h1>
        <p className="text-zinc-400 mb-8">Learn new skills from industry experts and seniors.</p>
